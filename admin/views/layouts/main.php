            ...
            $menuItems = [
                [
                    ...
                    'items' => [
                        ...
                        ['label' => Yii::t('app', 'Categories'), 'url' => ['/post-category']],
                        ...
                        ['label' => 'Изображения галерей', 'url' => ['/gallery-image']],
                    ]
                ],
                [
                    'label' => 'Управление',
                ...
                Html::tag(
                    'li',
                    Html::a(
                        sprintf('%s Выйти (%s)', Icon::show('sign-out-alt'), Yii::$app->user->identity->username),
                        ['/site/logout'],
